...
//     navigate('/submit-preview');
//   };

//   return (
//     <div className="container my-4">
//       <div className="d-flex justify-content-between align-items-center mb-4">
//         <h2 className="fw-bold text-primary">Online Test</h2>
...
//                     value={opt.option}
//                     onChange={() => handleChange(index, opt.option)}
//                     checked={answers[index] === opt.option}
//                   />
//                   {opt.option}
//                 </label>
//               ))}
...
function Test() {
  ...
  return (
    <div className="container-fluid my-4">
      ...
      {/* {q && (
        <div className="card mb-4 border border-primary-subtle shadow rounded-4 question-card">
          <div className="card-body">
            <h5 className="card-title fw-semibold mb-4">{currentQuestionIndex + 1}. {q.question}</h5>
            <div className="list-group">
              {q.options.map((opt, i) => (
                <label
                  key={i}
                  className="list-group-item list-group-item-action border border-secondary-subtle radio-hover"
